...
Route::group(['middleware' => ['jwt.verify']], function () {
    ...
    Route::put('card/monster', [CardMonsterController::class, 'update'])->name('monster.update');
    Route::delete('card/monster', [CardMonsterController::class, 'destroy'])->name('monster.delete');
    ...
    Route::put('card/magic', [CardMagicController::class, 'update'])->name('magic.update');
    Route::delete('card/magic', [CardMagicController::class, 'destroy'])->name('magic.delete');
    ...
    Route::put('card/trap', [CardTrapController::class, 'update'])->name('trap.update');
    Route::delete('card/trap', [CardTrapController::class, 'destroy'])->name('trap.delete');
